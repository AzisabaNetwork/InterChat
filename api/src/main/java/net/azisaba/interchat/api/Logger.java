...
import net.azisaba.interchat.api.util.ReflectionUtil;
...
public interface Logger {
    @NotNull Logger DEFAULT_LOGGER = createFromJavaLogger(java.util.logging.Logger.getLogger("InterChat"));
    ...
    static @NotNull Logger getCurrentLogger() {
        try {
            return InterChatProvider.get().getLogger();
